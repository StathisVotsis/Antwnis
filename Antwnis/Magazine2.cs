...
namespace Antwnis
{
    public partial class Magazine2 : Form
    {
        public Magazine2()
        {
            InitializeComponent();
        ...
        private void Magazine2_Load(object sender, EventArgs e)
        {
            try
            {
                // TODO: This line of code loads data into the 'antwnisDataSet2.magazine' table. You can move, or remove it, as needed.
                this.magazineTableAdapter.Fill(this.antwnisDataSet2.magazine);
            }
            catch (Exception)
            {
        ...
        private void dataGridView1_RowValidated(object sender, DataGridViewCellEventArgs e)
        {
            try
            {
                this.magazineTableAdapter.Update(this.antwnisDataSet2.magazine);
            }
            catch (Exception)
            {
                MessageBox.Show("Λάθος στην αποθήκευση");
        ...
        private void Magazine2_FormClosing(object sender, FormClosingEventArgs e)
        {
            try
            {
                this.Validate();
